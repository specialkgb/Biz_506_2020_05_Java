...
public class BankServiceImplV2 implements BankService {
	...
	/*
	 * BankService interface에 선언되지 않은 method로 BankServiceImplV2 클래스 내부에서만 사용하기 위해
	 * 구현한 method 단, BankServiceImplV2 클래스를 상속받게 되면 이 method를 사용할 수 있다.
	 * 
	 * protected 접근제한자는 이 클래스를 생성하고 사용하는 곳(main())에서는 호출하거나 접근을 할수 없다. 다만, 이 클래스를
	 * 상속받은 클래스에서는 제한적으로 호출하여 사용할수도 있다.
	 */

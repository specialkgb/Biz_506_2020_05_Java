...
public class BankEx_04 {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			/*
			 * interface를 설계할 당시 필요하지 않아 정의하지 않은 method는 보통 구현된 class 내에서만 사용하는 것으로 private,
			 * protected로 선언을 한다 그러나, 프로젝트가 진행되는 동안 구현된 class에 어떤 메서드를 추가하고 이 method를 외부에서
			 * 호출하여 어떤 행동을 수행해야할 필요가 있을때가 있다.
			 * 
			 * 객체를 선언할때 interface로 선언을 하면 클래스에 구현된 method를 직접 호출하는 것이 안된다. 이럴때 down Casting을
			 * 해서 해당 method를 사용할수 있다.
			 */

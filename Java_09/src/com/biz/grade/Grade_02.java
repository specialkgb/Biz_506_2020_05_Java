...
public class Grade_02 {
	...
	public static void main(String[] args) {
		...
		// 이 명령문은 Console에 표기하는 기능이 없기 때문에
		// 수행된 결과를 확인할 수 없을 뿐이다.
		// 점 연산을 사용하여 연결되는 명령문 중 ()가 부착되는 명령문을
		// method라고 부른다
		rnd.nextInt(); // rnd 객체의 nextInt() method라고 부른다.
		               // Random 클래스의 nextInt() method라고 부른다.
		...
		// 이 명령문은 끝의 println() method의 괄호 안에 있는
		// 값, 연산결과, 변수에 담긴 값 등을 Console에 보여주는 명령문이다.
		System.out.println(num);

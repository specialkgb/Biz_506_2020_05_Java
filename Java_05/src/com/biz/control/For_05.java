...
public class For_05 {
	public static void main(String[] args) {
		 ...
		 * for(;조건문;)의 결과값이 true이면 {}내의 명령문을 실행하고
		 * 결과값이 false이면 더 이상 반복하지 않고
		 * for()명령문을 종료한다.
		 * 조건문은
		 * if(조건){
		 * }else{
		 ...
		 * for(초기화명령; 조건문 ; 증감문)
		 * 1. for()명령문을 만나면
		 * 2. 초기화 명령을 무조건 실행한다.(단, 최초 1회)
		 * 3. 조건문을 실행하여 결과가 true이면 {} 안의 명령문을 실행한다.
		 * 4. {}안의 명령문을 실행한 후 다시 for() 명령문으로 이동하여
		 * 5. 증감(num++) 명령문을 실행한다.

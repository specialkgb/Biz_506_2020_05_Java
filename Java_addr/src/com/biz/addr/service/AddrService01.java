...
public class AddrService01 {
	 ...
	 * 선언만 된 필드변수 중에 객체형태의 변수는 그 변수에 값을 저장, 추가하려고 하면 NullpointerException이 발생하면서
	 * 코드가 실행이 되지 않는다
	 * 
	 * 아래의 1 ~ 3 까지의 방법으로 반드시 변수를 초기화 해주어야 한다.
	 * 1. 필드변수를 선언과 동시에 초기화 하기 -> 메모리 관리상 여러가지 문제를 일으킬 수 있기 때문에 가급적 사용하지 말자.
	 * 2. 생성자를 이용하여 초기화 하기
	 * 3. 사용하기 직전에 초기화 하기
	 * 
